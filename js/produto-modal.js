...
window.PaoDoCiso.configurarProduto        = configurarProduto;
window.PaoDoCiso.renderizarModalProduto   = renderizarModalProduto;
window.PaoDoCiso.alterarQuantidadeProduto = alterarQuantidadeProduto;
